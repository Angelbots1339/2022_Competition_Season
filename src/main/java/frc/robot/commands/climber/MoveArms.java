...
public class MoveArms extends CommandBase {
   ...
   */
  public MoveArms(ClimbingSubsystem climbingSubsystem, double lengthSetpoint, double angleSetpoint) {
  ...
  public MoveArms(ClimbingSubsystem climbingSubsystem, double lengthSetpoint) {
    this(climbingSubsystem, lengthSetpoint, climbingSubsystem.getRightAngle());
  }

  public MoveArms(double angleSetpoint, ClimbingSubsystem climbingSubsystem) {
